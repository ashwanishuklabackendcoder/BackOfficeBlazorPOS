...
namespace BackOfficeBlazor.Admin.Entities
{
    ...
    public class SysOption
    {
        ...
        [StringLength(250)]
        public string? PurchaseOrderMessage { get; set; }
        ...
        [StringLength(5)]
        public string? TillPaymentCardId { get; set; }

        [StringLength(5)]
        public string? TillPaymentICardId { get; set; }
        ...
        [StringLength(250)]
        public string? BACsDetails { get; set; }
        ...
        [StringLength(5)]
        public string? WorkshopPart1 { get; set; }

        [StringLength(100)]
        public string? WorkshopPart1Name { get; set; }

        [StringLength(5)]
        public string? WorkshopPart2 { get; set; }

        [StringLength(100)]
        public string? WorkshopPart2Name { get; set; }

        [StringLength(5)]
        public string? WorkshopPart3 { get; set; }

        [StringLength(100)]
        public string? WorkshopPart3Name { get; set; }

        [StringLength(5)]
        public string? WorkshopPart4 { get; set; }

        [StringLength(100)]
        public string? WorkshopPart4Name { get; set; }

        [StringLength(5)]
        public string? WorkshopPart5 { get; set; }

        [StringLength(100)]
        public string? WorkshopPart5Name { get; set; }
        public bool? VeloLifeInsurance { get; set; }
        public bool? BikmoInsurance { get; set; }
        public string? WorkshopCustomerServiceJobCardNarrative { get; set; }
        ...
        [StringLength(10)]
        public string? NxtPartNo { get; set; }

        [StringLength(10)]
        public string? NxtDespNo { get; set; }

        [StringLength(10)]
        public string? NxtStockNo { get; set; }

        [StringLength(10)]
        public string? NxtOrderNo { get; set; }

        [StringLength(10)]
        public string? NxtOrderRefNo { get; set; }

        [StringLength(10)]
        public string? NxtInvoiceNo { get; set; }
        public bool? AutoInvoice { get; set; }
        public bool? EnterPinOnTill { get; set; }
        public bool? CreaditOnDayAcc { get; set; }
        [StringLength(10)]
        public string? NxtBatchNo { get; set; }

        [StringLength(10)]
        public string? NxtQuoteNo { get; set; }

        [StringLength(500)]
        public string? TillMsg { get; set; }
        ...
        [StringLength(5)]
        public string? WhareHouseShopNo { get; set; }
